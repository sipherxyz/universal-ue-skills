...
- Treat changes to Blueprint-exposed `UFUNCTION`/`UPROPERTY` names, types, specifiers, or removals as breaking-risk; require deprecation/migration notes for affected assets. Usually `P1`.
